...
export const optionsReducer = createReducer<OptionsState, ActionType<typeof optionsCreators>>(
  INITIAL_STATE
)
  .handleAction(optionsCreators.updateOptions, (_, {payload}) => payload.options)
